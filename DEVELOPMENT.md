...
```bash
git remote add encore encore://inventory-management-saas-t4w2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/inventory-management-saas-t4w2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/inventory-management-saas-t4w2/settings/integrations/github)
